-- <!-- AGENT_HEADER
-- role: code
-- purpose: 049_task_events_spawn_usage — widen task_events.event_type
--   CHECK to admit 'spawn_usage' (M5+ token + cache accounting).
-- index: content
-- AGENT_HEADER_END -->
--
-- Verifies the M5 success-check gap with effective billable input
-- (input_tokens minus 90% of cache_read_input_tokens). Same rebuild
-- dance as migrations 046 + 048.

PRAGMA foreign_keys = OFF;

CREATE TABLE IF NOT EXISTS task_events_v4 (
    id              TEXT PRIMARY KEY,
    ...
    supersedes      TEXT REFERENCES task_events_v4(id),
...
INSERT OR IGNORE INTO task_events_v4 (
